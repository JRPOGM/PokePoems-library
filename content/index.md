...
This is a vault of all [poems](/secrets/pikachu), [artwork]() and [biographical data]() I have created over the past few months, focusing on the basic stage forms of [Pokémon]() from the first generation of games. This includes [sixty]()-[three]() different Pokémon all given their own treatment and themes, even if that isn’t [every Pokémon.]()
...
<footer>All these poems and more have been and will be published on the website AllPoetry, under the pen name [JRPOGM]()</footer>